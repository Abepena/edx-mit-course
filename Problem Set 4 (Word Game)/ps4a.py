...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for i in word:
            if i not in hand or hand_clone[i] == 0:
                return False
            else:
                hand_clone[i] -= 1
        return True
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                wordscore = getWordScore(word, calculateHandlen(hand_clone))
                total_score += wordscore
                print(
                    '" {} " earned {} points. Total score: {} points.'.format(
                        word, wordscore, total_score
                    )
                )
                print()
                # Update the hand
